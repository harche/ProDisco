...
/**
 * Indexable document for search-libs integration
 */
...
/**
 * Status of metric discovery
 */
export type MetricDiscoveryStatus = 'pending' | 'in_progress' | 'ready' | 'unavailable';

/**
 * Options for metric discovery
 */
export interface MetricDiscoveryOptions {
