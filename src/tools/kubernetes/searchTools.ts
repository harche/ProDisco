...
export const searchToolsTool: ToolDefinition<SearchToolsResult, typeof SearchToolsInputSchema> = {
  ...
  description:
    'Search and discover available Kubernetes tools. You can optionally create reusable scripts under `scripts/cache/` (e.g., `scripts/cache/list-pods.ts`) and run them with `npx tsx scripts/cache/<script>.ts`.',
